    ...
    return Scaffold(
       appBar: AppBar(
         brightness: Brightness.dark,
           centerTitle: true,
           title: Text("Market",style: TextStyle(/*color: Theme.of(context).textSelectionColor,*/fontFamily: "Gotik",fontWeight: FontWeight.w600,fontSize: 18.5),),
           actions: <Widget>[
             Padding(
           ...
           bottom: TabBar(
             ...
             tabs: <Widget>[
               new Tab(
        child: Text("FAV",style: TextStyle(fontFamily: "Popins"),),
               ),
               new Tab(
