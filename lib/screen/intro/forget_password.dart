...
class _forgetPasswordState extends State<forgetPassword> {
  ...
  doForgetPassword(BuildContext context) {
    ScaffoldMessenger.of(context)
        .showSnackBar(new SnackBar(content: new Text('Processing..')));
    Requests.post('https://raescript.com/mfp_dex/home/api/password_reset',
            body: {
      ...
      if (resp != null && resp.success) {
        ...
        final msg = resp.msg != null ? resp.msg : 'Failed to reset password';
        ScaffoldMessenger.of(context)
