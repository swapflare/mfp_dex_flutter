...
class _loginState extends State<login> {
  ...
  doLogin(BuildContext context) {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(new SnackBar(content: new Text('login in..')));
    Requests.post('https://raescript.com/mfp_dex/home/api/sign_in',
            body: {'email': _email, 'password': _password, 'login': 'login'},
      ...
      if (resp != null && resp.success) {
        doSavePreferences(_email, _password).then((value) {
          Navigator.of(context).pushReplacement(PageRouteBuilder(
              pageBuilder: (_, __, ___) =>
                  bottomNavBar(themeBloc: _themeBloc)));
        });
      } else {
        final msg = resp.msg != null ? resp.msg : 'Failed to login';
        ScaffoldMessenger.of(context)
  ...
  Future<void> doSavePreferences(String email, String password) async {
