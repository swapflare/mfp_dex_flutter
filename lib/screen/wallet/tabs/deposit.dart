         ...
         children: <Widget>[
           ...
           Padding(
             ...
             child: Row(
               ...
               children: <Widget>[
                 Text("Value (USDT)",style: TextStyle(color: Theme.of(context).hintColor.withOpacity(0.5),fontFamily: "Popins",fontSize: 15.5),),
                 Text("0.00",style: TextStyle(fontFamily: "Popins"),),
               ],
             ),
           ),
             Padding(
           ...
           Text("123jkb21k421435bhj325jk43536bj5",style: TextStyle(color: Theme.of(context).hintColor.withOpacity(0.7),fontFamily: "Popins",),),
