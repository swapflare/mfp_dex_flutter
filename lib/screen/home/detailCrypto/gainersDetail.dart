...
import 'package:crypto_template/screen/home/detailCrypto/SparklineGraphs.dart';
...
class _gainersDetailState extends State<gainersDetail> {
  ...
  List<Widget> d_verticalGraphicsScales() {
    double _maxValue = 0;
  ...
  List<Widget> _horizontalGraphicsScale() {
    return <Widget>[
      Text(
        "0hr",
        style: TextStyle(
          ...
          Flexible(
            child: ListView(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      ///
                      verticalGraphicsScaleGainers(context, item),

                      ///
                      /// Calling sparkLine Grafik
                      ///
                      sparkLineGraficGainers(item),
                    ],
                  ),
                ),
                ...
                ///
                horizontalGraphicsScale(context),
                SizedBox(
                  height: 20.0,
                ),
                Container(
  ...
  Widget _verticalValueGrafik(List<Widget> _verticalGraphicsScale) {
    return Padding(
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: _verticalGraphicsScale,
          ),
        ),
      ),
    );
  ...
  Widget _horizontalValueGrafik() {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: _horizontalGraphicsScale(),
      ),
    );
  }
