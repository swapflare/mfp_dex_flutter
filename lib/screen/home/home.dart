      ...
      if (value != null && value.length > 0) {
        setState(() {
          value.forEach((element) {
            loadedGridCard.add(card(gridHome.fromCoinMarketModel(element)));
          });
          loadCard = false;
        });
      }
        ...
        child: Column(
          children: <Widget>[
            ...
            loadCard
                ...
                : _cardLoaded(context, loadedGridCard),
...
///
///
Widget _cardLoaded(BuildContext context, List<card> loadedGridCard) {
  return GridView.count(
    shrinkWrap: true,
    padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 0.0),
    crossAxisSpacing: 12.0,
